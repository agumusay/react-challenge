...
export default function DnDFlow() {
	...
	return (
		<div className='grid h-[90vh] grid-cols-12 bg-gray-300 w-[80vw] dndflow gap-3'>
			<ReactFlowProvider>
				<Sidebar />

				<div
					className='relative col-span-9 col-start-4 rounded-sm shadow-inner reactflow-wrapper'
					ref={reactFlowWrapper}
					style={{ boxShadow: 'inset 3px 3px 5px rgba(0,0,0,0.5), inset -3px -3px 5px rgba(255,255,255,0.5)' }}>
					<div className='absolute right-0 flex flex-row top-[-30px]'>
						<button
